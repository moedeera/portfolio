...
const articles = [
  ...
  },
  {
    ...
    paragraph2:
      "That is not to say the Express and NodeJS have no value, far from it in fact. It’s just that their use without a front-end framework like ReactJS, Vue, or Angular is rare in the industry. PHP and Laravel on the other hand, are like an ace card when you go to small web design companies. Not only can you work within the WordPress ecosystem, you can create and build your own custom themes and plugins. This can save many companies both time and money in the long run. Many new developers never see this reality because most social media posts encourage them to learn the MERN stack and insinuate PHP as outdated tech",
    paragraph3:
      "Newcomers should ignore that sentiment and focus more on learning PHP and Laravel unless they are certain that the demand for the MERN stack is high where they live. Ultimately everyone’s situation is unique, but in my case I would have loved to learn PHP much sooner.",
  },
];
